...
# Title: Test Corr Est
# Generated: Tue Oct 31 09:08:34 2017
##################################################
...
class test_corr_est(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.rfid_corr_est_cc_1 = rfid.corr_est_cc((modulated_sync_word), 4, 1, 0.9)
        ...
        self.qtgui_time_sink_x_0_1.set_trigger_mode(qtgui.TRIG_MODE_TAG, qtgui.TRIG_SLOPE_POS, 0.0, 0.010, 0, 'time_est')
        ...
        self.top_grid_layout.addWidget(self._qtgui_time_sink_x_0_1_win, 2,0,1,2)
        self.qtgui_time_sink_x_0 = qtgui.time_sink_c(
        	50000, #size
        	samp_rate, #samp_rate
        	'Recovered clock and phase', #name
        	1 #number of inputs
        )
        ...
        self.connect((self.channels_channel_model_0, 0), (self.rfid_corr_est_cc_1, 0))
        ...
        self.connect((self.rfid_corr_est_cc_1, 1), (self.blocks_complex_to_float_0, 0))
        self.connect((self.rfid_corr_est_cc_1, 1), (self.blocks_complex_to_mag_0, 0))
        self.connect((self.rfid_corr_est_cc_1, 0), (self.digital_pfb_clock_sync_xxx_0, 0))
